...
int main(void)
{
	...
	Port(ENTER_BOOTLOADER_PIN).DIRCLR = (1<<2);
...
#pragma diag_default=Pe1053 // Back to default.
            ...
            else if(val == COMMAND_LED_ON) {                  // Turn Von LED
                #if (LED_ON == LOW)
