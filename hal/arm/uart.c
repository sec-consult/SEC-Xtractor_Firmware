...
static inline void uartInit(void)
{
	...
	GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODE10_Msk) | GPIO_MODER_MODER10_1;
	GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODE9_Msk) | GPIO_MODER_MODER9_1; 
	//Set Alternate function AF7 on PD8=TX + PD9=RX
	GPIOA->AFR[1] = (7 << GPIO_AFRH_AFSEL9_Pos) | (7 << GPIO_AFRH_AFSEL10_Pos);
	USART1->CR2 &= USART_CR2_STOP_Msk;      //One Stop bit
	USART1->CR1 |= USART_CR1_RXNEIE;

	//Set Hardware Flow control, Not functional yet
	// GPIOA->OSPEEDR |= (0x3<<GPIO_OSPEEDR_OSPEED11_Pos) | (0x3<<GPIO_OSPEEDR_OSPEED12_Pos);
	// GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODE11_Msk) | GPIO_MODER_MODER11_1;
	// GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODE12_Msk) | GPIO_MODER_MODER12_1; 
